            ...
            <div className="navbar-right">
                <div className="header-icons d-inline-block align-middle">
                   ...
                   <div className="position-relative d-none d-sm-inline-block">
                        <button className="header-icon btn btn-empty" type="button" id="iconMenuButton"
                                data-toggle="dropdown"
                                aria-haspopup="true" aria-expanded="false">
                            <i className="simple-icon-grid"></i>
                        </button>
                        <div className="dropdown-menu dropdown-menu-right mt-3  position-absolute"
                             id="iconMenuDropdown">
                        ...
                        <div className="dropdown-menu dropdown-menu-right mt-3 position-absolute"
                            ...
                            <div className="scroll">
                                <div className="d-flex flex-row mb-3 pb-3 border-bottom">
                                    ...
                                    <div className="pl-3">
                                        <a href="#">
                                            <p className="font-weight-medium mb-1">Joisse Kaycee just sent a new
                                                comment!</p>
                                ...
                                <div className="d-flex flex-row mb-3 pb-3 border-bottom">
                                    ...
                                    <div className="pl-3">
                                        <a href="#">
                                            <p className="font-weight-medium mb-1">New order received! It is total
                                                $147,20.</p>
                                            <p className="text-muted mb-0 text-small">09.04.2018 - 12:45</p>
                                        </a>
                                    </div>
                                ...
                                <div className="d-flex flex-row mb-3 pb-3 ">
                                    ...
                                    <div className="pl-3">
                                        <a href="#">
                                            <p className="font-weight-medium mb-1">3 items just added to wish list
                                                by a user!
                                            </p>
                                            <p className="text-muted mb-0 text-small">09.04.2018 - 12:45</p>
                                        </a>
                    ...
                    <button className="header-icon btn btn-empty d-none d-sm-inline-block" type="button"
                            id="fullScreenButton">
                ...
                <div className="user d-inline-block">
                    ...
                    <div className="dropdown-menu dropdown-menu-right mt-3">
                        ...
                        <a className="dropdown-item" onClick={this.handleClick} href="#">Sign out</a>
                    </div>
                </div>
            </div>
        </nav>

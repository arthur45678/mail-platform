        ...
        <div className="main-menu">
            <div className="scroll">
                <ul className="list-unstyled">
                    <li>
                        <NavLink to={'/dashboard'} className="iconsminds-shop-4">
                ...
                <ul className="list-unstyled" data-link="dashboard">
                    ...
                    <li>
                        <a href="Dashboard.Ecommerce.html">
                            <i className="simple-icon-basket-loaded"></i> <span
                            className="d-inline-block">Ecommerce</span>
                        </a>
                    </li>
                    <li>
                    ...
                    <li>
                        <a href="#" data-toggle="collapse" data-target="#collapseAuthorization" aria-expanded="true"
                           aria-controls="collapseAuthorization" className="rotate-arrow-icon opacity-50">
                            ...
                            className="d-inline-block">Authorization</span>
                        </a>
                            ...
                            <ul className="list-unstyled inner-level-menu">
                                ...
                                <li>
                                    <a href="Pages.Product.Detail.html">
                                        ...
                                        className="d-inline-block">Detail</span>
                                    </a>
                                </li>
                            </ul>
                        </div>
                            ...
                            <ul className="list-unstyled inner-level-menu">
                                <li>
                                    <a href="Pages.Profile.Social.html">
                                        <i className="simple-icon-share"></i> <span
                                        className="d-inline-block">Social</span>
                                    </a>
                                </li>
                                <li>
                                    <a href="Pages.Profile.Portfolio.html">
                                        <i className="simple-icon-link"></i> <span
                                        className="d-inline-block">Portfolio</span>
                                    </a>
                                </li>
                            </ul>
                        </div>
                            ...
                            <ul className="list-unstyled inner-level-menu">
                                <li>
                                    <a href="Pages.Blog.html">
                                        ...
                                        className="d-inline-block">List</span>
                                    </a>
                                </li>
                                <li>
                    ...
                    <li>
                        <a href="#" data-toggle="collapse" data-target="#collapseMisc" aria-expanded="true"
                           aria-controls="collapseMisc" className="rotate-arrow-icon opacity-50">
                            <i className="simple-icon-arrow-down"></i> <span
                            className="d-inline-block">Miscellaneous</span>
                        </a>
                            ...
                            <ul className="list-unstyled inner-level-menu">
                                ...
                                <li>
                                    <a href="Pages.Misc.Faq.html">
                                        <i className="simple-icon-question"></i> <span
                                        className="d-inline-block">Faq</span>
                                    </a>
                                </li>
                                <li>
                                    <a href="Pages.Misc.Invoice.html">
                                        <i className="simple-icon-bag"></i> <span
                                        className="d-inline-block">Invoice</span>
                                    </a>
                                </li>
                                <li>
                                ...
                                <li>
                                    <a href="Pages.Misc.Pricing.html">
                                        <i className="simple-icon-diamond"></i> <span
                                        className="d-inline-block">Pricing</span>
                                    </a>
                                </li>
                                <li>
                                    <a href="Pages.Misc.Search.html">
                                        <i className="simple-icon-magnifier"></i> <span
                                        className="d-inline-block">Search</span>
                                    </a>
                                </li>
                            ...
                            <ul className="list-unstyled inner-level-menu">
                                <li>
                                    <a href="Ui.Forms.Components.html">
                                        <i className="simple-icon-event"></i> <span
                                        className="d-inline-block">Components</span>
                                    </a>
                                </li>
                                <li>
                                    <a href="Ui.Forms.Layouts.html">
                                        <i className="simple-icon-doc"></i> <span
                                        className="d-inline-block">Layouts</span>
                                    </a>
                                </li>
                                <li>
                                    <a href="Ui.Forms.Validation.html">
                                        <i className="simple-icon-check"></i> <span
                                        className="d-inline-block">Validation</span>
                                    </a>
                                </li>
                                <li>
                    ...
                    <li>
                        <a href="#" data-toggle="collapse" data-target="#collapseDataTables" aria-expanded="true"
                           aria-controls="collapseDataTables" className="rotate-arrow-icon opacity-50">
                            <i className="simple-icon-arrow-down"></i> <span
                            className="d-inline-block">Datatables</span>
                        </a>
                            ...
                            <ul className="list-unstyled inner-level-menu">
                                ...
                                <li>
                                    <a href="Ui.Datatables.Scroll.html">
                                        <i className="simple-icon-mouse"></i> <span
                                        className="d-inline-block">Scrollable</span>
                                    </a>
                                </li>
                                <li>
                                ...
                                <li>
                                    <a href="Ui.Datatables.Default.html">
                                        <i className="simple-icon-grid"></i> <span
                            ...
                            <ul className="list-unstyled inner-level-menu">
                                <li>
                                    <a href="Ui.Components.Alerts.html">
                                        <i className="simple-icon-bell"></i> <span
                                        className="d-inline-block">Alerts</span>
                                    </a>
                                </li>
                                <li>
                                    <a href="Ui.Components.Badges.html">
                                        <i className="simple-icon-badge"></i> <span
                                        className="d-inline-block">Badges</span>
                                    </a>
                                </li>
                                <li>
                                ...
                                <li>
                                    <a href="Ui.Components.Cards.html">
                                        <i className="simple-icon-layers"></i> <span
                                        className="d-inline-block">Cards</span>
                                    </a>
                                </li>

                                <li>
                                    <a href="Ui.Components.Carousel.html">
                                        <i className="simple-icon-picture"></i> <span
                                        className="d-inline-block">Carousel</span>
                                    </a>
                                </li>
                                <li>
                                    <a href="Ui.Components.Charts.html">
                                        <i className="simple-icon-chart"></i> <span
                                        className="d-inline-block">Charts</span>
                                    </a>
                                </li>
                                <li>
                                ...
                                <li>
                                    <a href="Ui.Components.Icons.html">
                                        <i className="simple-icon-star"></i> <span
                                        className="d-inline-block">Icons</span>
                                    </a>
                                </li>
                                <li>
                                ...
                                <li>
                                    <a href="Ui.Components.Modal.html">
                                        <i className="simple-icon-docs"></i> <span
                                        className="d-inline-block">Modal</span>
                                    </a>
                                </li>
                                <li>
                                ...
                                <li>
                                    <a href="Ui.Components.Sortable.html">
                                        <i className="simple-icon-shuffle"></i> <span
                                        className="d-inline-block">Sortable</span>
                                    </a>
                                </li>
                                <li>
                                    <a href="Ui.Components.Tables.html">
                                        <i className="simple-icon-grid"></i> <span
                                        className="d-inline-block">Tables</span>
                                    </a>
                                </li>
                            </ul>
                        </div>
                    ...
                    <li>
                        <a href="#" data-toggle="collapse" data-target="#collapseMenuTypes" aria-expanded="true"
                           aria-controls="collapseMenuTypes" className="rotate-arrow-icon">
                            <i className="simple-icon-arrow-down"></i> <span
                            className="d-inline-block">Menu Types</span>
                        </a>
                    ...
                    <li>
                        <a href="#" data-toggle="collapse" data-target="#collapseMenuLevel" aria-expanded="true"
                           aria-controls="collapseMenuLevel" className="rotate-arrow-icon collapsed">
                            <i className="simple-icon-arrow-down"></i> <span
                            className="d-inline-block">Menu Levels</span>
                        </a>
